#!/usr/bin/env python3
"""v0.2.1 additions concat + sanitize.

Builds data/ray-stack-sft-v0.2.1-additions.jsonl by concatenating:
...
- data/v021-short-prompt-discrimination-2026-05-23.jsonl (20 new)
- data/v021-fabrication-discrimination-2026-05-23.jsonl (40 new)
...
OUT = DATA_DIR / "ray-stack-sft-v0.2.1-additions.jsonl"
...
def main() -> int:
    ...
    print(f"v0.2.1 additions assembled at {OUT}")
