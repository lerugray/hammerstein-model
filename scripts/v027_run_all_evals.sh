#!/bin/bash
# v0.2.7 — drive all evals (6 new + preservation set) against hammerstein-7b-v027.
# Runs sequentially because local Ollama serves one request at a time.
set -e
cd "$(dirname "$0")/.."
...
# Preservation set — re-run existing v0.2.6.x evals against v0.2.7
...
echo ""
echo "=== v0.2.7 eval driver complete ==="
date
echo ""
