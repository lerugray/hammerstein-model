...
echo ""
echo " To pull results back to your local machine, from your local terminal:"
echo "   POD=<pod-ip-or-host>"
echo "   LOCAL_REPO=<your-local-checkout-of-hammerstein-model>"
echo "   scp -i ~/.ssh/your-pod-key root@\$POD:$REPO_DIR/tools/distill/data/eval-*.jsonl \\"
echo "     \"\$LOCAL_REPO/tools/distill/data/\""
